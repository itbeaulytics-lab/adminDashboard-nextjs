  ...
  return (
    <div className="container mx-auto max-w-5xl py-8">
      ...
      <div className="text-center mb-10">
        ...
        <h1 className="text-3xl font-extrabold text-gray-900 dark:text-white tracking-tight">Upload Produk Kosmetik</h1>
        <p className="text-gray-500 dark:text-gray-400 mt-2 text-lg">Tambahkan produk baru ke dalam katalog</p>
        ...
        <section className="bg-white dark:bg-[#121212] rounded-2xl shadow-sm border border-gray-100 dark:border-gray-800 p-8">
          <div className="flex items-center gap-3 mb-6">
            ...
            <div>
              ...
              <p className="text-sm text-gray-500 dark:text-gray-400">Nama, brand, kategori, dan harga produk (wajib diisi)</p>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div className="space-y-2">
              ...
              <input
                ...
                onChange={(e) => setFormData({ ...formData, brand: sanitizeText(e.target.value) })}
                className="w-full px-4 py-3 rounded-xl bg-gray-50 dark:bg-[#0a0a0a] border border-gray-200 dark:border-gray-800 text-gray-900 dark:text-white focus:ring-2 focus:ring-indigo-500 focus:border-transparent outline-none transition-all placeholder:text-gray-400 dark:placeholder:text-gray-600"
            ...
            <div className="space-y-2">
              ...
              <input
                ...
                onChange={(e) => setFormData({ ...formData, price: sanitizeText(e.target.value) })}
                min="0"
                step="1"
                className="w-full px-4 py-3 rounded-xl bg-gray-50 dark:bg-[#0a0a0a] border border-gray-200 dark:border-gray-800 text-gray-900 dark:text-white focus:ring-2 focus:ring-indigo-500 focus:border-transparent outline-none transition-all placeholder:text-gray-400 dark:placeholder:text-gray-600"
          ...
          <div className="space-y-6">
            ...
            <div className="space-y-2">
              ...
              <textarea
                ...
                onChange={(e) => setFormData({ ...formData, ingredients: sanitizeText(e.target.value) })}
                rows={3}
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div className="space-y-2">
                ...
                <input
                  type="text"
                  value={formData.size}
                  onChange={(e) => setFormData({ ...formData, size: sanitizeText(e.target.value) })}
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="space-y-2">
              ...
              <input
                ...
                onChange={(e) => setFormData({ ...formData, tokopedia_url: sanitizeUrl(e.target.value) })}
            ...
            <div className="space-y-2">
              ...
              <input
                ...
                onChange={(e) => setFormData({ ...formData, shopee_url: sanitizeUrl(e.target.value) })}
