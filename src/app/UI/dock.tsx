  ...
  return (
    <motion.div style={{ height, scrollbarWidth: 'none' }} className="mx-2 flex max-w-full items-center">
      <motion.div
        ...
        className={`${className} fixed z-50 bottom-4 left-1/2 transform -translate-x-1/2 flex items-end w-fit gap-4 rounded-2xl border border-white/20 bg-white/10 backdrop-blur-xl shadow-lg pb-2 px-4`}
